...
uint256 hashGenesisBlock("0xcea3c3a6e91939c37cf3041e5f263f6ee424a21156547ddeebc6a672e4fe38aa");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // Testage: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Testage Signed Message:\n";
...
{
    // Testage: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 920000 blocks, which will occur approximately every 1.5 years
    nSubsidy >>= (nHeight / 920000); // Testage: 920k blocks est 1.5 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 360; // Testage: 360 seconds until DGW3 at block 60
static const int64 nTargetSpacing = 60; // Testage: 60 seconds
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Testage: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Testage: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Testage: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6bcf57c6b5cc57f1a1c39fdf4870bcd91f287fe34726868360e0d0b6cd1644a9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("3c7752d56de1011699b958bbed7c078b1e034ae9854d17e6e2aaa00a906d9ed2927b23eeb076dc4887e12249a2a512d378cf84dece7adfea4bea9368847da1a45d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1486826150;
        block.nBits    = 537261531;
        block.nNonce   = 2072573220;

        if (fTestNet)
        {
            block.nTime    = 1486826150;
            block.nNonce   = 1934185330;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x216b54b1d9f4e94a95d4a3dc0b4bb880f787d29bd345663961614ca9049a4585"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Testage: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TestageMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TestageMiner : ProcessBlock, block not accepted");
    }
